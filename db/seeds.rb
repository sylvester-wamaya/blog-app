...
Comment.create([{post_id: 1, author_id: 2, text: 'Hi Tom!' }, {post_id: 1, author_id: 2, text: 'Hello Tom!' }])
Like.create([{author_id:2, post_id:1},{author_id:2, post_id:1},{author_id:2, post_id:2}])